...
@Service
@Slf4j
public class ReplyMessageHandler implements LineClientUtil {
	...
	private Map<Double,String> medicineStoreMap = new HashMap<>();
...
//			dist = dist * 1.609344;
    ...
    public void handleLocationMessageRely(MessageEvent<LocationMessageContent> event) {
		...
		for (int i = 0 ; i < 5 ; i++) {
			String id = medicineStoreMap.get(topTenCloestMedicineStore[i]);
